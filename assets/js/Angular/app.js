var schoex = angular.module('schoex',['ngRoute','ngCookies','ngUpload','ui.autocomplete','angularUtils.directives.dirPagination']).run(function($http,dataFactory,$rootScope) {
...
schoex.controller('mainController', function(dataFactory,$rootScope,$scope) {
...
schoex.controller('registeration', function(dataFactory,$scope) {
  $scope.views = {};
  $scope.classes = {};
...
schoex.controller('subjectsController', function(dataFactory,$scope) {
  $scope.subjects = {};
  $scope.teachers = {};
  $scope.classes = {};
  $scope.views = {};
...
schoex.controller('teachersController', function(dataFactory,CSRF_TOKEN,$scope,$sce) {
  $scope.teachers = {};
  $scope.transports = {};
...
schoex.controller('studentsController', function(dataFactory,CSRF_TOKEN,$scope,$sce) {
  $scope.students = {};
  $scope.classes = {};
  $scope.transports = {};
...
schoex.controller('parentsController', function(dataFactory,CSRF_TOKEN,$scope,$compile,$sce,$rootScope) {
  $scope.stparents = {};
  ...
  $scope.myOption = {
        options: {
            ...
            source: function(request, response) {
                $.getJSON(appBaseUrl+"/parents/search/"+request.term, {}, function(data) {
        ...
        events: {
          select: function( event, ui ) {
            $scope.form.studentInfo.push({"student":ui.item.label,"relation":"","id":ui.item.value});
          }
        }
    };
...
schoex.controller('newsboardController', function(dataFactory,$scope) {
  $scope.newsboard = {};
  $scope.views = {};
  $scope.views.list = true;
  $scope.form = {};
...
schoex.controller('libraryController', function(dataFactory,CSRF_TOKEN,$scope) {
  $scope.library = {};
  $scope.views = {};
  $scope.views.list = true;
  $scope.form = {};
...
schoex.controller('accountSettingsController', function(dataFactory,CSRF_TOKEN,$scope,$route) {
  $scope.account = {};
  $scope.views = {};
  $scope.views.list = true;
  $scope.form = {};
...
schoex.controller('classScheduleController', function(dataFactory,$scope) {
  $scope.classes = {};
  $scope.subject = {};
  $scope.days = {};
  $scope.classSchedule = {};
...
schoex.controller('settingsController', function(dataFactory,$scope,$route) {
  $scope.views = {};
  $scope.form = {};
  $scope.languages = {};
  var methodName = $route.current.methodName;
...
schoex.controller('gradeLevelsController', function(dataFactory,$scope) {
  $scope.gradeLevels = {};
  $scope.views = {};
  $scope.views.list = true;
  $scope.form = {};
...
schoex.controller('examsListController', function(dataFactory,$scope,$sce) {
  $scope.examsList = {};
  $scope.classes = {};
  $scope.subjects = {};
  $scope.userRole ;
...
schoex.controller('eventsController', function(dataFactory,$scope) {
  $scope.events = {};
  $scope.views = {};
  $scope.views.list = true;
  $scope.form = {};
...
schoex.controller('assignmentsController', function(dataFactory,CSRF_TOKEN,$scope) {
  $scope.classes = {};
  $scope.subject = {};
  $scope.assignments = {};
  $scope.views = {};
...
schoex.controller('mailsmsController', function(dataFactory,$scope) {
  $scope.classes = {};
  $scope.views = {};
  $scope.messages = {};
...
schoex.controller('messagesController', function(dataFactory,$route,$scope) {
  $scope.messages = {};
  $scope.message = {};
  $scope.messageDet = {};
  $scope.totalItems = 0;
...
schoex.controller('onlineExamsController', function(dataFactory,$scope,$sce) {
  $scope.classes = {};
  $scope.subject = {};
  $scope.onlineexams = {};
  $scope.views = {};
...
schoex.controller('pollsController', function(dataFactory,$scope) {
  $scope.polls = {};
  $scope.views = {};
  $scope.views.list = true;
  $scope.form = {};
...
schoex.controller('dormitoriesController', function(dataFactory,$scope) {
  $scope.dormitories = {};
  $scope.views = {};
  $scope.views.list = true;
  $scope.form = {};
...
schoex.controller('languagesController', function(dataFactory,$scope) {
  $scope.languages = {};
  $scope.views = {};
  $scope.views.list = true;
  $scope.form = {};
