...
<html>
    ...
    <body class="skin-<?php echo $panelInit->settingsArray['layoutColor']; ?> fixed" ng-app="schoex" ng-controller="mainController">
            ...
            <nav class="navbar navbar-static-top" role="navigation">
                ...
                <div class="navbar-right">
                    <ul class="nav navbar-nav">
                        <?php
                        if(isset($latestVersion) AND isset($latestVersionUrl)){
                            ?>
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <div class="pull-right" style='margin:20px;'><?php echo $panelInit->settingsArray['footer']; ?> - <a target="_BLANK" href="{{URL::to('/terms')}}"><?php echo $panelInit->language['schoolTerms']; ?></a></div>
        </div>
