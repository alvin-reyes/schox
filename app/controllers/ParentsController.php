...
class ParentsController extends \BaseController {
	...
	public function export(){
		...
		foreach ($student as $value) {
			$data[] = array ($value->fullName,$value->username,$value->email,$value->gender,$value->address,$value->phoneNo,$value->mobileNo,$value->birthday,$value->parentProfession,"",$value->activated,$value->parentOf);
		}
	...
	public function searchStudents($student){
		$students = User::where('role','student')->where('fullName','like','%'.$student.'%')->get();
		$retArray = array();
		foreach ($students as $student) {
			$retArray[$student->id] = $student->fullName;
		}
